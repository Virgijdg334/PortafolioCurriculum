        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-lg text-muted-foreground">
                  Especializado en aplicaciones multiplataforma y tecnologías cloud
                </p>
              </div>
            </motion.div>
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-400 rounded-2xl blur-xl opacity-30" />
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1733412505442-36cfa59a4240?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9ncmFtbWluZyUyMGNvZGUlMjBkYXJrJTIwc2NyZWVufGVufDF8fHx8MTc1ODExMTI3MHww&ixlib=rb-4.1.0&q=80&w=1080"
                alt="Código de programación"
                className="relative w-full max-w-md mx-auto h-96 object-cover rounded-2xl shadow-2xl"
              />
              ...
              <motion.div
                ...
                className="absolute -left-4 top-8 bg-card/80 backdrop-blur-sm border rounded-lg p-3"
              >
              ...
              <motion.div
                ...
                className="absolute -right-4 bottom-8 bg-card/80 backdrop-blur-sm border rounded-lg p-3"
              >
